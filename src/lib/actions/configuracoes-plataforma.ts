...
const SchemaConfig = z.object({
  ...
  admin_org_pode_trocar_perfil:    z.boolean(),
}).refine(
...
export async function salvarConfiguracoes(
  input: {
    prazo_urgencia_parecer_dias: number
    prazo_alerta_parecer_dias: number
    admin_org_pode_trocar_perfil: boolean
  }
  ...
  const updates: Array<Partial<ConfiguracaoPlataformaRow>> = [
    { chave: 'prazo_urgencia_parecer_dias',   valor: String(parsed.data.prazo_urgencia_parecer_dias),   updated_by: user.id, updated_at: now },
    { chave: 'prazo_alerta_parecer_dias',     valor: String(parsed.data.prazo_alerta_parecer_dias),     updated_by: user.id, updated_at: now },
    { chave: 'admin_org_pode_trocar_perfil',  valor: String(parsed.data.admin_org_pode_trocar_perfil),  updated_by: user.id, updated_at: now },
  ]
