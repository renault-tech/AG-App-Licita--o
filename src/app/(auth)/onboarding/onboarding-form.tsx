...
import { Building2, User, ChevronRight, Loader2, LogOut } from 'lucide-react'
      ...
      <CardHeader>
        <div className="flex items-start justify-between gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-xs text-gray-400 hover:text-gray-600 transition-colors shrink-0 mt-0.5"
          >
