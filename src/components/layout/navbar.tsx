...
import { LogOut, Settings, FileText, LayoutDashboard, Users, Zap, ChevronDown, Menu, X, Building2, TrendingUp, ShieldCheck, Bell, Share2, Scale, Calculator } from 'lucide-react'
...
const NAV_LINKS = [
  ...
  { href: '/cotacao', label: 'Cotacao', icon: Calculator },
